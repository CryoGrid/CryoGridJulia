...
include("StrataModules/SEDIMENT_T_saltConc.jl")
...
# set run variables
savename = "testlocation1_withSalt"
...
terrestrial = SEDIMENT_T_saltConc.stratum();
marine = SEDIMENT_T_saltConc.stratum();
...
interaction_heat_salt = CryoGridInteractions.IA_HEAT_SALT();
...
TOP.NEXT.IA_NEXT = interaction_heat_salt;
